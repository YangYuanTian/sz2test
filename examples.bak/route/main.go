...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc $BPF_CLANG -cflags $BPF_CFLAGS bpf route.c  -- -I../headers/ -I../headers/bpf/include/linux/  -I../headers/bpf/include/linux/byteorder/  -I../headers/bpf/ -I../headers/bpf/lib/ -I../headers/bpf/include/bpf/ -I../headers/bpf/include/bpf/ctx/
