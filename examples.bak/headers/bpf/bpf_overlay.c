...
__section_tail(CILIUM_MAP_CALLS, CILIUM_CALL_IPV6_FROM_OVERLAY) int tail_handle_ipv6(struct __ctx_buff *ctx) {
...
__section_tail(CILIUM_MAP_CALLS, CILIUM_CALL_IPV4_FROM_OVERLAY) int tail_handle_ipv4(struct __ctx_buff *ctx) {
	__u32 src_identity = 0;
