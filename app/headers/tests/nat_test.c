...
static __always_inline int mock_ct_lookup4(
    __maybe_unused const void *map, __maybe_unused struct ipv4_ct_tuple *tuple,
    __maybe_unused struct __ctx_buff *ctx, __maybe_unused int off,
    __maybe_unused enum ct_dir dir, __maybe_unused struct ct_state *ct_state,
    __maybe_unused __u32 *monitor) {
  return mock_ct_lookup4_response;
}

static int mock_ct_create4_response = 1;
static __always_inline int mock_ct_create4(
    __maybe_unused const void *map_main, __maybe_unused const void *map_related,
    __maybe_unused struct ipv4_ct_tuple *tuple,
    __maybe_unused struct __ctx_buff *ctx, __maybe_unused const int dir,
    __maybe_unused const struct ct_state *ct_state,
    __maybe_unused bool proxy_redirect, __maybe_unused bool from_l7lb) {
