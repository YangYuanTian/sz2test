...
sock_select_slot(struct bpf_sock_addr *ctx) {
  return ctx->protocol == IPPROTO_TCP ? get_prandom_u32()
...
#else
static __always_inline int
sock4_update_revnat(struct bpf_sock_addr *ctx __maybe_unused,
 ...
 * service translation.
 */
static __always_inline bool sock4_skip_xlate_if_same_netns(
...
#else
static __always_inline int
sock6_update_revnat(struct bpf_sock_addr *ctx __maybe_unused,
...
static __always_inline int
sock6_xlate_v4_in_v6(struct bpf_sock_addr *ctx __maybe_unused,
